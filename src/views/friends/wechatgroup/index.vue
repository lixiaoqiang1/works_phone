            ...
            <el-table stripe :data="userList" style="width: 100%">
              <el-table-column label="微信群">
                <template scope="scope">
                  <div class="bule_color" @click="btnqun('aaa')">
              ...
              <el-table-column label="跟进员工微信">
                <template scope="scope">
                  <div class="bule_color" @click="btnqun2('aaa2')">
...
<script>
  export default {
    ...
    methods: {
      ...
      btnqun(aaa){
        console.log('sasa1');
        this.$router.push({ path:'hyperlinks', query: { id: 111 }});
      },
      //员工超链接
      btnqun2(aaa2){
        console.log('sasa2');
        this.$router.push({ path:'hyperlinks2', query: { id: 222 }});
      }
    }
  };
</script>